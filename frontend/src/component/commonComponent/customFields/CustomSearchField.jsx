...
const CustomSearchField = ({
    ...
    return (
        <div className={` ${className} flex relative input-search`}>
            ...
            <input
                className={`ts-input-search ${InputWidth} fu-search-marg dark:border-gray-600 dark:bg-gray-700 dark:text-white disabled:bg-gray-100 dark:disabled:bg-gray-200 disabled:cursor-not-allowed`}
                type={type}
                value={value}
